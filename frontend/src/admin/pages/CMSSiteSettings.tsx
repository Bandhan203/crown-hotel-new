    ...
    <div className="space-y-6">
      ...
      <div className="space-y-5">
        <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-5">
          <h2 className="text-white font-semibold text-lg mb-4">Branding</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm text-gray-300 mb-1">Light Logo URL</label>
        ...
        <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {['facebook', 'twitter', 'instagram', 'tripadvisor', 'linkedin'].map((network) => (
              <div key={network}>
                <label className="block text-sm text-gray-300 mb-1 capitalize">{network} URL</label>
